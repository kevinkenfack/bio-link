...
const NeoBiolink = () => {
  ...
  const socialLinks = [
    { name: 'Newsletter', icon: <MailIcon className="w-5 h-5 text-orange-400" />, color: 'from-orange-500/20 to-pink-500/20' },
    { name: 'GitHub', icon: <GithubIcon className="w-5 h-5" />, color: 'from-gray-600/20 to-gray-700/20' },
    { name: 'LinkedIn', icon: <LinkedinIcon className="w-5 h-5" />, color: 'from-blue-500/20 to-blue-600/20' },
    { name: 'Twitter', icon: <TwitterIcon className="w-5 h-5" />, color: 'from-blue-400/20 to-blue-500/20' },
    { name: 'Instagram', icon: <InstagramIcon className="w-5 h-5" />, color: 'from-pink-500/20 to-purple-500/20' },
    { name: 'Buy Me a Coffee', icon: <CoffeeIcon className="w-5 h-5" />, color: 'from-yellow-500/20 to-orange-500/20' },
  ];
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="block">
                    ...
                    <p className="text-sm text-gray-400">Web Solutions & Innovation</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-gray-950/95 rounded-3xl p-6 backdrop-blur-xl overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-400 mb-4">
                    Celebrating my journey in creating cutting-edge web applications and helping developers grow.
                  </p>
                ...
                <div className="bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-3xl p-6 backdrop-blur-sm border border-white/5 transition-all duration-300 hover:border-white/10">
                  <div className="flex flex-col sm:flex-row items-start gap-6">
                    <div className="relative flex-shrink-0">
                      <div className="w-20 h-20 rounded-2xl overflow-hidden transition-transform duration-300 group-hover:scale-105 bg-white/5 flex items-center justify-center">
